...
def test_vector_proximity_status(mock_robot):
    ...
    mock_robot.proximity.last_sensor_reading.signal_quality = 0.95
    ...
    assert result["signal_quality"] == 0.95
...
def test_vector_proximity_status_no_object(mock_robot):
    ...
    assert set(result.keys()) == {
        "status", "distance_mm", "signal_quality", "unobstructed", "found_object", "is_lift_in_fov",
    }
